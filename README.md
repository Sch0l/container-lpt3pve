...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lpt3pve.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lpt3pve.containers.anotherwebservice.com/
...
```
git clone git@github.com:Sch0l/container-lpt3pve.git
cd container-lpt3pve
```
...
```
docker attach container-lpt3pve
```
